      ...
      <div class="form-group">
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputDefault" name="ci" required>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputDefault" name="apaterno" required>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="form-group">
            <label class="control-label" for="inputDefault">Apellido materno</label>
            <input type="text" class="form-control" id="inputDefault" name="amaterno" required>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="form-group">
            <label class="control-label" for="inputDefault">Fecha de nacimiento</label>
            <input type="date" class="form-control" id="inputDefault" name="fnacimiento" required>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="form-group">
        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputDefault" name="folio" required>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="form-group">
            <label class="control-label" for="inputDefault">Clave de acceso</label>
            <input type="text" class="form-control" id="inputDefault" name="clave" required>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="form-group">
            <label class="control-label" for="inputDefault">Tipo de usuario</label required>
                ...
                <fieldset>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <div class="radio">
                            <label>
                              <input name="ida" type="radio" value="1" checked/>
