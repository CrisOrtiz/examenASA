...
<div class="container">
    <div class="col-md-12">
        <h3>Listado de preguntas<a href="#" class="btn btn-danger pull-right" onclick="mdformpregunta()"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Agregar pregunta</a></h3>  
    </div>
                ...
                { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="modifica_pregunta.php?idPregunta=<?php print($obj->idPregunta);?>"  onclick="" class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                        </td>
                    </tr>
                    <?php }
