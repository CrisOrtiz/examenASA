...
class aspiranteDao
{
    ...
    function  registrarAspiranteDao($aspirante){        
        ...
        $datosArray=array($aspirante->ci,$aspirante->nombre,$aspirante->apaterno,$aspirante->amaterno,$aspirante->fnacimiento,$aspirante->folio,$aspirante->clave,$aspirante->correo,$aspirante->tipo);
    ...
    function actualizarAspiranteDao($aspirante){
        $datosArray=array($aspirante->ci,$aspirante->nombre,$aspirante->apaterno,$aspirante->amaterno,$aspirante->fnacimiento,$aspirante->folio,$aspirante->clave,$aspirante->correo,$aspirante->id);
