    ...
    {    
        ...
        if($r == 0){            
            ...
            if($query!=false){ 
              ...
              <h2><strong>Bien hecho!</strong> Ahora ya puedes ver los resultados que obtuviste, buena suerte. :)</h2>
              </div>
              <center> <div><h2><a href="resultados.php" >resultados</a></h2></div></center>
            ...
            $mensaje='<div class="alert alert-dismissible alert-warning">
              ...
              <h4>Ops!</h4>
              <p><h2>Las respuestas ya fueron registradas. :|</h2></p>
              </div>
